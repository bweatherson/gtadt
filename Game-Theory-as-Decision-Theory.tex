...
Theory} (\citeproc{ref-Bonanno2018}{Bonanno, 2018}). This book has two
...
(\citeproc{ref-Nozick1969}{n.d.}), such a demon is typically taken to be
...
Following Nozick (\citeproc{ref-Nozick1969}{n.d.}), the most common
...
\tightlist
\item
  Frank Arntzenius (\citeproc{ref-Arntzenius2008}{2008}) and Johan E.
  Gustafsson (\citeproc{ref-Gustafsson2011}{2011}) recommend Choosing A.
\item
  ...
  (\citeproc{ref-Barnett2022}{2022}) recommend choosing B.
\item
...
\item
  Jack Spencer (\citeproc{ref-Spencer2021b}{2021}) and Melissa Fusco
  (\citeproc{ref-Fuscond}{n.d.}) say that Chooser can rationally take
  either option.
\end{enumerate}
...
theories that reject both CDT and EDT.\footnote{The most notable of
  ...
  (\citeproc{ref-LevinsteinSoares2020}{2020}), and the
  non-expectationist theories of Quiggin
  (\citeproc{ref-Quiggin1982}{1982}) and Buchak
...
(\citeproc{ref-Harper1986}{1986}), in a paper that was a central
...
(\citeproc{ref-McClennen1990}{1990}), and the functional theorists, in
the sense of Levinstein \& Soares
(\citeproc{ref-LevinsteinSoares2020}{2020}). But GDT disagrees with them
...
problem.\footnote{One might have expected it would be easy to generate
  ...
  (\citeproc{ref-Bonanno2018}{Bonanno, 2018: 86}) into demonic decision
  ...
  (\citeproc{ref-Stalnaker1999}{1999}) in ruling out weakly dominated
...
Lara Buchak (\citeproc{ref-BuchakRisk}{2013}) defends.\footnote{Buchak
  offers a very clear outline of her view in her
  (\citeproc{ref-Buchak2017}{2017}).} Imagine that Suzy has two things
...
choice of the ticket or the dollar. Billy's risk-function\footnote{On
  ...
  (\citeproc{ref-Buchak2017}{Buchak, 2017: 2366}).} \emph{r} is
...
Soares (\citeproc{ref-LevinsteinSoares2020}{2020}). The optimal strategy
...
what Julia Robinson dubbed the `travelling salesman' problem.\footnote{The
  dubbing is in Robinson (\citeproc{ref-Robinson1949}{1949}). For a
...
call that problem one in \emph{non-ideal decision theory}.\footnote{I'm
  ...
  Valentini (\citeproc{ref-Valentini2012}{2012}) for a good survey of
  some relevant work, and Mills (\citeproc{ref-Mills2005}{2005}) for an
  ...
  (\citeproc{ref-Sen2006}{2006}), argue that we shouldn't base non-ideal
...
working in philosophy.\footnote{The exceptions are people working in
  `descriptive decision theory' (\citeproc{ref-ChandlerSEP}{Chandler,
  2017}). But that's normally not taken to be a normative theory; it
...
worse.\footnote{This is a special case of Lipsey and Lancaster's Theory
  of the Second Best (\citeproc{ref-LipseyLancaster}{Lipsey \&
...
space.\footnote{I'm drawing here on work on the nature of idealisations
  by Michael Strevens (\citeproc{ref-Strevens2008}{2008}) and by Kevin
  Davey (\citeproc{ref-Davey2011}{2011}).}
...
well as computational ones.\footnote{John Conlisk
  (\citeproc{ref-Conlisk1996}{1996}) stresses that explaining the
...
(\citeproc{ref-Keynes1923}{Keynes, 1923: 80}, emphasis in original)
\end{quote}
...
(\citeproc{ref-Wilson1967}{1967}).\footnote{I learned about this paper
  from the excellent discussion of the case in Sutton
  (\citeproc{ref-Sutton2000}{2000}).} Another example of this working is
George Akerlof's discussion of the used car market Akerlof
(\citeproc{ref-Akerlof1970}{1970}). In the twentieth century, it was
...
decision theory.\footnote{Bonanno (\citeproc{ref-Bonanno2018}{2018:
  216}) makes a somewhat similar point with the example of the drowning
...
better if they can. (\citeproc{ref-Lewis-Mellor-14101981}{Lewis, 2020:
432})
\end{quote}
...
consumer choice.\footnote{See Barta, Gurrea, \& Flavián
  (\citeproc{ref-Barta2023}{2023}) for a relatively recent example,
...
``offset''.\footnote{See Conlisk (\citeproc{ref-Conlisk1996}{1996}) for
...
(\citeproc{ref-EysterRabin2005}{Eyster \& Rabin, 2005}). The
...
do empirically fairly well.\footnote{And there are even more empirically
  ...
  Palfrey (\citeproc{ref-fong2023cursed}{2023}) and Shani Cohen \& Li
  (\citeproc{ref-cohen2023sequential}{2023}).} Their models have people
...
we're assuming away. (\citeproc{ref-GrantEtAl2021}{Grant, Ani, \&
Quiggin, 2021})
...
(\citeproc{ref-Quiggin1982}{1982}) and Buchak
(\citeproc{ref-BuchakRisk}{2013}). On the other hand, there are
...
literatures have almost nothing in common.\footnote{There is a survey
  ...
  (\citeproc{ref-Elliot2019}{2019}) - that has summaries of the then
...
(\citeproc{ref-Allais1953}{1953}) showed, this implies that
...
(\citeproc{ref-Jackson1998}{Jackson, 1998}, Ch. 2). The role of
...
include\footnote{Philosophers often attribute the result that
  ...
  (\citeproc{ref-Good1967}{1967}), but it's really just a reformulation
  of a result due to David Blackwell
  (\citeproc{ref-Blackwell1951}{1951}), which I think is a better
  attribution. That said, Das (\citeproc{ref-Das2023}{2023}) notes that
  a similar result is in an old note by C. S. Peirce
  (\citeproc{ref-Peirce1876}{1967}), first published in an academic
  setting in 1967, but (according to Wible
  (\citeproc{ref-Wible1994}{1994})), published in a US government report
...
best result that way. Das (\citeproc{ref-Das2023}{2023}) argues that
...
Sure Thing. Dmitri Gallow (\citeproc{ref-Gallownd}{n.d.}) argues that
...
general, the value of currency is typically highly uncertain.\footnote{See
  Alcoba (\citeproc{ref-Alcoba2023}{2023}) for what happens when people
...
harder time handling even simple money bets.\footnote{Joanna Thoma
  (\citeproc{ref-Thoma2019}{2019}) develops a subtle critique of some
  ...
  observation Ray Briggs (\citeproc{ref-Briggs2015}{2015}) makes that
...
committed a broadly causal version of decision theory.\footnote{This
  point is made by Harper (\citeproc{ref-Harper1988}{1988}), and many
...
Problem (\citeproc{ref-Lewis1979e}{Lewis, 1979}). They endorse the
...
probabilities.\footnote{See, for instance, the introduction of them on
  page 136 of Bonanno (\citeproc{ref-Bonanno2018}{2018}). And note that
...
theory that doesn't agree.\footnote{This objection goes back to Richter
  (\citeproc{ref-Richter1984}{1984}). The most memorable version of an
  asymmetric problem with no ratifiable choice is the Psychopath Button
  case presented by Andy Egan (\citeproc{ref-Egan2007}{2007}).}

A related objection is raised by Arif Ahmed
(\citeproc{ref-Ahmed2014a}{2014}) and by Jack Spencer and Ian Wells
(\citeproc{ref-SpencerWells2019}{2019}). I'll focus on the latter
...
(\citeproc{ref-Bonanno2018}{Bonanno, 2018: 41}); no matter what Chooser
...
(\citeproc{ref-Pearce1984}{1984}) shows, an option is sometimes a best
response iff it is not strictly dominated by any other pure or mixed
strategy.\footnote{Bonanno (\citeproc{ref-Bonanno2018}{2018: 207})
...
decision theorists, such as Lewis (\citeproc{ref-Lewis1981e}{1981}), use
...
(\citeproc{ref-LevinsteinSoares2020}{2020}) endorse also endorse the
...
role in a celebrated theorem by Nash (\citeproc{ref-Nash1951}{1951}). In
...
following two reasons.\footnote{These reasons are both offered, briefly,
  by Nozick (\citeproc{ref-Nozick1969}{n.d.}), so they have a history in
...
value, especially when there are predictors around.\footnote{This point
  ...
  (\citeproc{ref-Morgenstern1935}{1976})).} It's not good to lose every
...
theorists. Richard Jeffrey (\citeproc{ref-Jeffrey1983}{1983}) added a
...
(\citeproc{ref-Weirich1985}{1985}) and Harper
(\citeproc{ref-Harper1986}{1986}). It subsequently fell out of
popularity, though it has been recently endorsed by Fusco
(\citeproc{ref-Fuscond}{n.d.}). The loss of popularity was for two
reasons.
...
(\citeproc{ref-Skyrms1984}{1984}), since in
...
(\citeproc{ref-Harper1986}{1986}) did, and as I argued in
...
would be considerably better.\footnote{Note that this is true even if
  ...
  (\citeproc{ref-Goodsellnd}{n.d.}), that arises in decision theory with
  unbounded utilities.} Ahmed (\citeproc{ref-Ahmed2012}{2012}) says that
...
\item
  ...
  \emph{i}.''(\citeproc{ref-Bonanno2018}{Bonanno, 2018: 119})
\end{itemize}
\end{quote}
...
that person from descriptive duplicates.\footnote{Following Stalnaker
  (\citeproc{ref-Stalnaker2008}{2008}), I think this constraint means
  that we can't represent the Sleeping Beauty problem (Elga
  (\citeproc{ref-Elga2000}{2000})) as a tree, since in that problem
...
Nature (\citeproc{ref-Bonanno2018}{Bonanno, 2018: 134ff}). Nature is
...
Most game theorists deny this equivalence.\footnote{The next few
  ...
  threats (\citeproc{ref-Bonanno2018}{Bonanno, 2018: 86ff}).} The
...
decision theory.\footnote{That particular term, `resolute', is
  ...
  (\citeproc{ref-McClennen1990}{McClennen, 1990}). As already indicated,
...
in Hammond (\citeproc{ref-Hammond1988}{1988}). And it gets at what is
...
they will work backwards.\footnote{See the discussion of backward
  induction on pages 80ff of Bonanno (\citeproc{ref-Bonanno2018}{2018}).}
...
(\citeproc{ref-Stalnaker1999}{1999}) defends this view in game theory.
...
Chooser's strategy.\footnote{This problem is very closely modelled on a
  game described by Stalnaker (\citeproc{ref-Stalnaker1998}{1998: 47}).
...
Levinstein \& Soares (\citeproc{ref-LevinsteinSoares2020}{2020}). My
...
(\citeproc{ref-Gallownd}{n.d.}) has described. If the pure
...
they will do, what act is rational for them changes.\footnote{The point
  ...
  between certain outcomes (\citeproc{ref-Bonanno2018}{Bonanno, 2018:
  80ff}).} I don't think this is ever an issue for CEDT, but it is an
...
Ruth Chang (\citeproc{ref-Chang2002}{2002}), that two options are
...
call Stag Hunt decisions.\footnote{For much more on the philosophical
  ...
  (\citeproc{ref-Skyrms2004}{2004}).} Here is an example of a Stag Hunt
decision.
...
EDT in Jeffrey (\citeproc{ref-Jeffrey1983}{1983}). Some causal decision
theorists, such as Arntzenius (\citeproc{ref-Arntzenius2008}{2008}) and
Gustafsson (\citeproc{ref-Gustafsson2011}{2011}), also say Chooser
should play Up. On the other hand, several other causal decision
theorists, like Wedgwood (\citeproc{ref-Wedgwood2013a}{2013}), Gallow
(\citeproc{ref-Gallow2020}{2020}), Podgorski
(\citeproc{ref-Podgorski2022}{2022}), and Barnett
(\citeproc{ref-Barnett2022}{2022}), endorse playing Down on the ground
...
(\citeproc{ref-RamseyGeneralProp}{Ramsey, 1990}). Denying Exit Principle
...
(\citeproc{ref-Stalnaker1998}{1998})). But there is a special case of it
...
Principle.\footnote{To be sure, it's not entirely clear how to even
  ...
  (\citeproc{ref-Gallownd}{n.d.}) makes to theories that endorse Sure
...
(\citeproc{ref-Spencer2023}{2023}) used to model the kind of case that's
at issue. As he notes, it is similar to the psychopath button case
(\citeproc{ref-Egan2007}{Egan, 2007}), the asymmetric Death in Damascus
case (\citeproc{ref-Richter1984}{Richter, 1984}), and other puzzles for
CDT.

\begin{longtable}[]{@{}ccc@{}}
\caption{Frustrating Button (from Spencer
(\citeproc{ref-Spencer2023}{2023})).}\label{tbl-frustrating-button}\tabularnewline
\toprule\noalign{}
\endfirsthead
\endhead
\bottomrule\noalign{}
...
rather than Up.\footnote{The theory offered in Spencer
  (\citeproc{ref-Spencer2021b}{2021}) agrees with intuition here.} This
...
theory offered by Lara Buchak (\citeproc{ref-BuchakRisk}{2013}), but
...
(\citeproc{ref-Samuelson1938}{1938}), Chernoff
(\citeproc{ref-Chernoff1954}{1954}), and Sen
(\citeproc{ref-Sen1971}{1971}). This is consistent with the practice in
game theory. Think about the use of solution concepts like subgame
perfect equilibrium (\citeproc{ref-Bonanno2018}{Bonanno, 2018}, sec 4.4)
or Perfect Bayesian equilibrium (\citeproc{ref-Bonanno2018}{Bonanno,
2018}, ch.~13). These describe which choices are acceptable in dynamic
...
(\citeproc{ref-Sen1971}{1971}), though it is often also (following
Moulin (\citeproc{ref-Moulin1985}{1985})) called the Chernoff condition.
...
(\citeproc{ref-Lewis-Gorman-10071979}{Lewis, n.d.: 472})
\end{quote}
...
I'll convince many people of something this sweeping.\footnote{My own
  ...
  Externalism} (\citeproc{ref-Weatherson2019}{Weatherson, 2019}).}
...
(\citeproc{ref-ChoKreps1987}{1987}), gives us reason to deny that
...
Rationality} (\citeproc{ref-Worsnip2021}{Worsnip, 2021}). Here's his
definition:
...
here. Wooram Lee (\citeproc{ref-Leend}{n.d.}) raises some different
...
search for one feels like a degenerating research program.\footnote{See
  also Heinzelmann (\citeproc{ref-Heinzelmannnd}{n.d.}) for a different
...
developed by Cho \& Kreps (\citeproc{ref-ChoKreps1987}{1987}). In this
...
(\citeproc{ref-Selten1975}{Selten, 1975}), and Roger Myerson's notion of
proper equilibrium (\citeproc{ref-Myerson1978}{Myerson, 1978}). If a
...
it follows straight away that it is good to keep doing this.\footnote{This
  ...
  (\citeproc{ref-HareHedden2015}{2015}).} Think about
...
First, as Bonanno (\citeproc{ref-Bonanno2018}{2018: 37}) points out, in
...
(\citeproc{ref-BenPorathDekel1992}{1992}). The money burning game has
...
(\citeproc{ref-Stalnaker1998}{1998}) points out, is that it confuses
...
\bibitem[\citeproctext]{ref-Alcoba2023}
...
\bibitem[\citeproctext]{ref-Barta2023}
...
\bibitem[\citeproctext]{ref-BottomleyWilliamsonnd}
...
\bibitem[\citeproctext]{ref-Buchak2017}
...
\bibitem[\citeproctext]{ref-ChandlerSEP}
...
\bibitem[\citeproctext]{ref-cohen2023sequential}
...
\bibitem[\citeproctext]{ref-Egan2007}
...
\bibitem[\citeproctext]{ref-fong2023cursed}
...
\bibitem[\citeproctext]{ref-Good1967}
...
\bibitem[\citeproctext]{ref-HareHedden2015}
...
\bibitem[\citeproctext]{ref-Harper1988}
...
\bibitem[\citeproctext]{ref-Heinzelmannnd}
...
\bibitem[\citeproctext]{ref-Leend}
...
\bibitem[\citeproctext]{ref-Lewis1981e}
...
\bibitem[\citeproctext]{ref-Mills2005}
...
\bibitem[\citeproctext]{ref-Morgenstern1935}
...
\bibitem[\citeproctext]{ref-Myerson1978}
...
\bibitem[\citeproctext]{ref-OConnor2019}
...
\bibitem[\citeproctext]{ref-Peirce1876}
...
\bibitem[\citeproctext]{ref-Sen2006}
...
\bibitem[\citeproctext]{ref-Skyrms1984}
...
\bibitem[\citeproctext]{ref-Smullyan1978}
...
\bibitem[\citeproctext]{ref-Valentini2012}
...
\bibitem[\citeproctext]{ref-Weirich1985}
...
\bibitem[\citeproctext]{ref-Wible1994}
...
\bibitem[\citeproctext]{ref-Worsnip2021}
...
\bibitem[\citeproctext]{ref-WrightVaguenessCollection}
...
(\citeproc{ref-Selten1975}{1975}). Instead of letting Demon choose a
...
Smullyan's books, especially his (\citeproc{ref-Smullyan1978}{1978}).
...
(\citeproc{ref-Lewis1979e}{Lewis, 1979}). But what I want to stress here
...
Andy Egan (\citeproc{ref-Egan2007}{2007}) raises as a problem for Causal
Decision Theory.
...
(\citeproc{ref-GibbardHarper1978}{1978}).

Let's do one last one, starting with the familiar game Battle of the
Sexes.\footnote{O'Connor (\citeproc{ref-OConnor2019}{2019}) calls this
...
from Richter (\citeproc{ref-Richter1984}{1984}).
...
(\citeproc{ref-ChoKreps1987}{1987}) as a demonic decision problem. I'm
...
flip their own coin to make a guess.\footnote{A key part of the
  discussion in Cho \& Kreps (\citeproc{ref-ChoKreps1987}{1987}) is that
...
(\citeproc{ref-Gallow2020}{2020}) endorses implies that one should play
...
Allais (\citeproc{ref-Allais1953}{1953}). For another, it doesn't seem
...
(\citeproc{ref-BottomleyWilliamsonnd}{n.d.}). But it's a guide to how we
...
attention vary along two dimensions.\footnote{For a much more thorough
  ...
  \& Hlobil (\citeproc{ref-Lota2023}{2023}), Palmira
...
(\citeproc{ref-Cohen2013}{2013}) defends the view that multiple
attitudes can be rational, but one cannot rationally acknowledge a
distinct view as rational. Following Kopec \& Titelbaum
(\citeproc{ref-KopecTitelbaum2016}{2016}), call a view that says
...
to zero. (\citeproc{ref-Xefteris2015}{Xefteris, 2015: 124})
\end{quote}
...
(\citeproc{ref-GrecoHedden2016}{Greco \& Hedden, 2016: 373}).
\end{quote}
