...
(\citeproc{ref-Nozick1969}{1969}), such a demon is typically taken to be
...
Following Nozick (\citeproc{ref-Nozick1969}{1969}), the most common
...
\item
  Ralph Wedgwood (\citeproc{ref-Wedgwood2012}{2012}), Dmitri Gallow
...
(\citeproc{ref-McClennan1990}{1990a}), and the functional theorists, in
...
worse.\footnote{This is a special case of Lipsey and Lancaster's Theory
  of the Second Best (\citeproc{ref-LipseyLancaster}{Lipsey and
...
better if they can. (\citeproc{ref-Lewis1981Mellor}{Lewis 2020a, 432})
\end{quote}
...
consumer choice.\footnote{See
  (\citeproc{ref-Barta2023}{\textbf{Barta2023?}}) for a relatively
...
(\citeproc{ref-EysterRabin2005}{Eyster and Rabin 2005}). The
...
do empirically fairly well.\footnote{And there are even more empirically
  ...
  and Palfrey (\citeproc{ref-fong2023cursed}{2023}) and Shani Cohen and
  Li (\citeproc{ref-cohen2023sequential}{2023}).} Their models have
...
we're assuming away. (\citeproc{ref-GrantEtAl2021}{Grant, Ani, and
Quiggin 2021})
...
harder time handling even simple money bets.\footnote{Joanna Thoma
  ...
  observation Ray (\citeproc{ref-Briggs2015}{\textbf{Briggs2015?}})
...
Problem (\citeproc{ref-Lewis1979e}{Lewis 1979}). They endorse the causal
...
theory that doesn't agree.\footnote{This objection goes back to Richter
  ...
  case presented by Andy Egan (\citeproc{ref-Egan2007}{2007a}).}
...
following two reasons.\footnote{These reasons are both offered, briefly,
  by Nozick (\citeproc{ref-Nozick1969}{1969}), so they have a history in
...
value, especially when there are predictors around.\footnote{This point
  ...
  ((\citeproc{ref-Morgenstern1935}{\textbf{Morgenstern1935?}})).} It's
...
decision theory.\footnote{That particular term, `resolute', is
  ...
  (\citeproc{ref-McClennen1990}{McClennan 1990b}). As already indicated,
...
Levinstein and Soares (\citeproc{ref-LevinsteinSoares2020}{2020}). My
...
(\citeproc{ref-Egan2007-EGASCT}{Egan 2007b}), the asymmetric Death in
Damascus case (\citeproc{ref-Richter1984}{Richter 1984}), and other
puzzles for CDT.
...
(\citeproc{ref-Lewis-Gorman-10071979}{Lewis 2020b, 472})
\end{quote}
...
least one of the states. (\citeproc{ref-Worsnip2021}{Worsnip 2021, 132})
\end{quote}
...
developed by Cho and Kreps (\citeproc{ref-ChoKreps1987}{1987}). In this
...
Andy Egan (\citeproc{ref-Egan2007}{2007a}) raises as a problem for
...
flip their own coin to make a guess.\footnote{A key part of the
  discussion in Cho and Kreps (\citeproc{ref-ChoKreps1987}{1987}) is
...
\bibitem[\citeproctext]{ref-Lewis1981Mellor}
...
\bibitem[\citeproctext]{ref-McClennan1990}
