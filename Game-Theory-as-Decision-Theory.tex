...
value, especially when there are predictors around.\footnote{This point
  ...
  (\citeproc{ref-Morgenstern1935}{{[}1935{]} 1976})).} It's not good to
...
EDT in Jeffrey (\citeproc{ref-Jeffrey1983}{1983}), and some causal
decision theorists such as Arntzenius
(\citeproc{ref-Arntzenius2008}{2008}) and Gustafsson
(\citeproc{ref-Gustafsson2011}{2011}). On the other hand, several other
...
permissible.\footnote{The view I'm going to develop is hence similar to
  the `permissive CDT' defended by Fusco (\citeproc{ref-Fuscond}{n.d.}).}
...
principle \(\alpha\) by Sen (\citeproc{ref-Sen1971}{1971}), though it is
often also (following Moulin (\citeproc{ref-Moulin1985}{1985})) called
...
criterion'' of Cho and Kreps (\citeproc{ref-ChoKreps1987}{1987}) is
...
(\citeproc{ref-Worsnip2021}{Worsnip 2021}). Here's his definition:
...
(\citeproc{ref-Leend}{n.d.}) raises some different challenges for
...
degenerating research program.\footnote{See also Heinzelmann
  (\citeproc{ref-Heinzelmannnd}{n.d.}) for a different set of reasons to
...
Cho and Kreps (\citeproc{ref-ChoKreps1987}{1987}), here translated into
