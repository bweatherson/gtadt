...
I'll start with a case we've seen before, the two stage Newcomb Problem I used earlier to argue against EDT: @tbl-edt-war. As a reminder, the game has three players, Chooser, Demon-1, and Demon-2. And it plays out over the following four stages.^[As usual, each demon is arbitrarily accurate with their predictions, and their errors are probabilistically independent.]
...
Earlier, I represented the game as a pair of tables, repeated here as @tbl-edt-war-reprise
